...
<div class="mx-auto max-w-6xl px-4 py-12 sm:px-6 md:py-16">
    <div class="reveal max-w-3xl">
        ...
        <h1 class="mt-2 text-3xl font-extrabold tracking-tight text-slate-900 md:text-4xl">Get in Touch</h1>
        <p class="mt-2 text-slate-500">Freelance, contract, or remote roles in system development, cybersecurity, and DevOps. Fastest response via WhatsApp.</p>
    </div>
    ...
    <div class="mt-8 grid gap-6 md:grid-cols-5">
        ...
        <form method="POST" action="{{ route('contact.store') }}" class="reveal rounded-xl border border-slate-200 bg-white p-6 shadow-sm md:col-span-3" data-reveal-delay="120">
            @csrf
            ...
            <button type="submit" class="mt-5 inline-flex items-center gap-2 rounded-lg bg-brand px-6 py-2.5 text-sm font-semibold text-white transition hover:bg-brand-dark">
